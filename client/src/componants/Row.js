...
const Row = ({ img, index, profession }) => {
  ...
  return (
    <div
      ref={rowRef}
      className={`relative opacity-0 py-4 bg-gradient-to-r from-gray-50 to-gray-400 pl-2 shadow-xl shadow-gray-600 rounded-lg flex items-center gap-6 my-20 flex-col md:flex-row ${
